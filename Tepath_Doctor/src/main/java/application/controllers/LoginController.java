...
/**
 * Die Klasse LoginController beinhaltet das Login für den Arzt. Einfach
 * gestaltet mit einer kurzen Begruessung und einem Login mit Benutzername,
 * Passwort und Login-Button. Die Klasse LoginController ist die
 * Controller-Klasse für die FXML-Datei login.fxml.
 * 
 * @author Hager
 *
 */
public class LoginController {
	...
	/**
	 * Damit der Arzt auf die Patientenverwaltung zugreifen kann, muss er sich
	 * zuerst einloggen. Wenn das Feld fuer Benutzername/Passwort leer oder
	 * nicht das richtige enthaelt wird im Feld Benutzername "Benutzername evtl.
	 * Falsch" und im Feld Passwort "Passwort evtl. falsch" angezeigt
	 * 
	 * @param event
	 *            login
	 */
